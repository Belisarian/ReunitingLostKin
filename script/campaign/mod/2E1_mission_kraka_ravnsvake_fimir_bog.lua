...
mod[mission_key] = {
	...
	locs = {
		...
		mission_desc = "Kraka Ravnsvake's commander of arms and high armour to the keep, Jorin Asserbo, is looking for able warriors to join an assault on a Fimir Bog. The Bog lies 2 days to the east, in one of Kraka Ravnsvake important hunting grounds. While a priority to the commander, more pressing matters have taken his attention, why he is looking for sellswords, that can handle the task.\n\n Payment upon completion: 4000",
	},
