...
mod.move_mission_sjoktraken = {
	...
	locs = {
		...
		mission_desc = "The band of prospectors have joined up with the mining company, they will stay out here in the abandoned mines of the Goromadny mountains for the coming season.  Your bookkeeper Nilss looks at you. The prospectors  might find something of value or a small vein of precious metals, but you both know that something else will find them before summer comes and the Sjoktraken mining company will fund a new expedition for they safe return. We should head back, its not safe out here.",
	},
