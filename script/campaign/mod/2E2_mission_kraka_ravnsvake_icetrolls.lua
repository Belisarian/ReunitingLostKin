...
mod[mission_key] = {
	...
	locs = {
		...
		mission_desc = "The Gianthome mountains have become increasingly harder to travel for both mining parties and merchants alike. The main road towards Grung Trakekarag has been blocked for months by a small host of Ice Troll, who have settled a glacier close to the main passageway. The mountain Rangers commander Sigmund Tranesong need warriors that can cleanse the land of these vile Ice Trolls. \n\n Payment upon completion: 3000",
	},
