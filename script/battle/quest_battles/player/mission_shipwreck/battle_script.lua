...
gc:add_element(nil, "battle_shipwreck_speech_01", "gc_orbit_360_slow_commander_front_left_close_low_01", 5000, true, false, false);
gc:add_element(nil, "battle_shipwreck_speech_02", "gc_orbit_90_medium_commander_back_right_extreme_high_01", 7000, false, false, false);
gc:add_element(nil, "battle_shipwreck_speech_03", "gc_orbit_ccw_90_medium_commander_back_left_close_low_01", 9000, false, false, false);
gc:add_element(nil, "battle_shipwreck_speech_04", "gc_slow_enemy_army_pan_front_right_to_front_left_close_medium_01", 6000, false, false, false);
gc:add_element(nil, "battle_shipwreck_speech_05", "gc_fast_commander_front_medium_medium_to_close_low_01", 6000, false, false, false);
...
gb:queue_help_on_message("NPC_deployed", "mission_shipwrecke_objective_5_message", 8000, 2000, 1000); -- "A Frost Wyrm! Careful, it's here to hunt!"
gb:queue_help_on_message("NPC_deployed", "mission_shipwrecke_objective_6_message", 8000, 2000, 30000); -- "The Norscans were baiting the Frost Wyrm with the mammoth, it seems we've interrupted their hunt!"
